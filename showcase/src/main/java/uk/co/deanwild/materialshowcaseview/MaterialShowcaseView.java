...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public static MaterialShowcaseView showcaseView;
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (parentView != null) {
            int[] point = new int[2];
            parentView.getLocationInWindow(point);
            Rect rect = new Rect(point[0], point[1], parentView.getWidth() + point[0], parentView.getHeight() +
                    point[1]);
            Paint paint = new Paint();
            paint.setColor(mMaskColour);
    ...
    public void hide() {
        /**
         * This flag is used to indicate to onDetachedFromWindow that the showcase view was dismissed purposefully
    ...
    public void animateOut() {
        mAnimationFactory.animateOutView(this, mTarget.getPoint(), mFadeDurationInMillis, new IAnimationFactory
    ...
    public static class Builder {
        ...
        public Builder setParentView(View view) {
            showcaseView.setParentView(view);
            return this;
        }
